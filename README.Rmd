...
<!-- badges: start -->
[![Vmisc status badge](https://popov-lab.r-universe.dev/badges/Vmisc)](https://popov-lab.r-universe.dev/Vmisc)
<!-- badges: end -->
...
You can install the development version of Vmisc from [GitHub](https://github.com/) with:
